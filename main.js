                ...
                <vertical gravity="center" layout_weight="1">
                    ...
                    <vertical margin="0 5" padding="10 6 0 6" bg="#ffffff" w="*" h="auto" elevation="1dp">
                        ...
                        <vertical id="experimentalFixes" visibility="gone" margin="5 3" w="*">
                            ...
                            <Switch id="doNotAutoRecover" margin="0 3" w="*" checked="false" textColor="#000000" text="停用游戏崩溃带崩脚本的临时解决方案" />
                            <text id="doNotAutoRecoverText1" visibility="gone" textSize="12" text="脚本可以监工游戏,防止游戏因为掉线/闪退/内存泄漏溢出而中断自动周回。但是游戏掉线时貌似有几率会带着脚本一起崩溃,原因不明。" textColor="#000000" />
                            <text id="doNotAutoRecoverText2" visibility="gone" textSize="12" text="为了对付这个问题,目前有个临时的办法(需要root或adb权限),就是在logcat里监控游戏是否崩溃,崩溃后再杀一次游戏进程,然后重启脚本。目前只有“副本周回(剧情/活动通用)”脚本支持这个功能。" textColor="#000000" />
                            <text id="doNotAutoRecoverText3" visibility="gone" textSize="12" text="开启这个选项后,就会停用上述这个临时解决方案。" textColor="#000000" />
                        </vertical>
                    </vertical>
