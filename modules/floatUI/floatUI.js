...
function algo_init() {
    ...
    function compatCaptureScreen() {
        return MODULES.shellScreenCap.compatCaptureScreen(limit.rootScreencap);
    }
    var startScreenCapture = MODULES.shellScreenCap.startScreenCapture;
    var renewImage = MODULES.shellScreenCap.renewImage;
    var recycleAllImages = MODULES.shellScreenCap.recycleAllImages;
